      ...
      <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed bg-card shadow-sm dark:bg-[#1a190b]">
        <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="max-w-sm">
                <h2 className="text-lg font-bold text-foreground">Todos os Pedidos</h2>
                <p className="text-sm text-muted-foreground">
                    Esta seção está em desenvolvimento. Em breve, você poderá gerenciar todos os pedidos recebidos por aqui.
                </p>
            </div>
        </div>
      </div>
